...
// error:
// No field 'socialSecurityNo' found in repl.MdocSession.MdocApp.Person @ PersonButMoreFields.socialSecurityNo
...
``` scala 
  ((new Person2(
    int = new Wrapped[Int](person.int),
    str = person.str.map[Wrapped[String]]((src: String) => new Wrapped[String](src)),
    inside = new Inside2(
    ...
    collectionOfNumbers = person.collectionOfNumbers
      .map[Wrapped[Float]]((`src₂`: Float) => new Wrapped[Float](`src₂`))
      .to[List[Wrapped[Float]]](iterableFactory[Wrapped[Float]])
  ): Person2): Person2)
```
...
``` scala 
  {
...

    {
      ...
      new Person2(
        int = Wrapped.apply[Int](value$proxy14.int.+(100)),
        str = Some.apply[Wrapped[String]](Wrapped.apply[String]("ConstString!")),
        inside = new Inside2(
          int = value$proxy14.inside.int,
          str = value$proxy14.inside.str,
          inside = Some.apply[EvenMoreInside2](
            new EvenMoreInside2(str = value$proxy14.inside.inside.str, int = value$proxy14.inside.inside.int)
          )
        ),
        collectionOfNumbers = value$proxy14.collectionOfNumbers
          .map[Wrapped[Float]]((src: Float) => new Wrapped[Float](src))
          .to[List[Wrapped[Float]]](iterableFactory[Wrapped[Float]])
      ): Person2
    }: Person2
...
``` scala 
  {
    ...
    val inside: Inside2 = new Inside2(
      int = person.inside.int,
      str = person.inside.str,
      inside = Some.apply[EvenMoreInside2](new EvenMoreInside2(str = person.inside.inside.str, int = person.inside.inside.int))
    )
...
``` scala 
  {
  val inst: AppliedViaBuilder[Person, Nothing, Function4[Wrapped[Int], Option[Wrapped[String]], Inside2, List[Wrapped[Float]], Person2], Nothing] = inline$instance[Person, Function4[Wrapped[Int], Option[Wrapped[String]], Inside2, List[Wrapped[Float]], Person2]](person, ((int: Wrapped[Int], str: Option[Wrapped[String]], inside: Inside2, collectionOfNumbers: List[Wrapped[Float]]) => Person2.apply(int, str, inside, collectionOfNumbers)))
  ...
  }] = inst.asInstanceOf[[args >: Nothing <: FunctionArguments, retTpe >: Nothing <: Any] => AppliedViaBuilder[Person, retTpe, Function4[Wrapped[Int], Option[Wrapped[String]], Inside2, List[Wrapped[Float]], Person2], args][FunctionArguments {
    val int: Wrapped[Int]
    val str: Option[Wrapped[String]]
    val inside: Inside2
    val collectionOfNumbers: List[Wrapped[Float]]
  ...
  ({
    val value$proxy18: Person = AppliedViaBuilder_this.inline$value
    val function$proxy29: Function4[Wrapped[Int], Option[Wrapped[String]], Inside2, List[Wrapped[Float]], Person2] = AppliedViaBuilder_this.inline$function

    (function$proxy29.apply(Wrapped.apply[Int](value$proxy18.int.+(100)), Some.apply[Wrapped[String]](Wrapped.apply[String]("ConstStr!")), new Inside2(int = value$proxy18.inside.int, str = value$proxy18.inside.str, inside = Some.apply[EvenMoreInside2](new EvenMoreInside2(str = value$proxy18.inside.inside.str, int = value$proxy18.inside.inside.int))), value$proxy18.collectionOfNumbers.map[Wrapped[Float]](((src: Float) => new Wrapped[Float](src))).to[List[Wrapped[Float]]](iterableFactory[Wrapped[Float]])): Person2)
  }: Person2)
}
```
