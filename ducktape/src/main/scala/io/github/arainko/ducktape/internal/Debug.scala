      ...
      extension (value: A)
        def show(using Quotes): String = {
          ...
          prod.productElementNames
            ...
            .collect {
              case label -> debug -> value if !(debug eq Debug.nonShowable) =>
