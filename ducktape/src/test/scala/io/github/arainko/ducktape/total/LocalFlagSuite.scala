...
class LocalFlagSuite extends DucktapeSuite {
  ...
  test("source field local flag covers the selected case class and nothing else") {
    case class Source(int: Int, str: String, level1: SourceLevel1)
    case class SourceLevel1(int: Int, str: String, level2: SourceLevel2)
    case class SourceLevel2(int: Int, str: String)
  ...
  test("source field local flag covers the selected subtype of an enum and nothing else") {
  ...
  test("source field local flag covers all subtypes of an enum and nothing else") {
  ...
  test("dest field local flag covers all subtypes of an enum and nothing else") {
    case class Source(int: Int, level1: SourceEnum)
    case class Dest(int: Int, level1: DestEnum)
  ...
  test("source field local flag covers all subtypes of an enum and nothing else (even when the enum is nested)") {
    case class Source(int: Int, level1: SourceEnum)
    case class Dest(int: Int, level1: DestEnum)
  ...
  test("dest field local flag covers all subtypes of an enum and nothing else (even when the enum is nested)") {
    case class Source(int: Int, level1: SourceEnum)
    case class Dest(int: Int, level1: DestEnum)
  ...
  test("source case local flag covers the selected subtype (picked as a field in case class)") {
    case class Source(int: Int, level1: SourceEnum)
    case class Dest(int: Int, level1: DestEnum)
  ...
  test("source case local flag DOESN'T cover the selected subtype (picked as a subtype with .at)") {
    ...
    assertTransformsConfigured(
      ...
      Case.modifySourceNames(_.toLowerCase).local(_.level1.at[SourceEnum.Two]): @nowarn(
  ...
  test("dest case local flag DOESN'T cover the selected subtype (picked as a subtype with .at)") {
    ...
    assertTransformsConfigured(
      ...
      Case.modifyDestNames(_.toLowerCase).local(_.level1.at[DestEnum.Two]): @nowarn(
        "msg=Config is not actually being used anywhere"
      )
    )
  }
